...
- ✅ Перевести проект на **TypeScript** (компоненты, store, API).
- ✅ Внедрить ИИ в БД для создания ИИ-агента.
- ⬜ Добавить **React Query (TanStack)** для работы с асинхронными запросами и кэшем.  
- ⬜ Настроить **юнит-тесты** (Jest + React Testing Library).  
- ⬜ Добавить **e2e-тесты** (Cypress).  
- ⬜ Перейти на **Tailwind CSS** для быстрой и удобной адаптивной вёрстки.  
- ⬜ Провести **оптимизацию** (улучшение Lighthouse-метрик и производительности).  
- ⬜ Настроить **CI/CD** (GitHub Actions: линтинг, тесты, билд).  
```
